...
func inputData(i int) (int, int, int) {
	...
	return jumlahMenu, jumlahOrang, sisaMakanan
}
...
func main() {
	...
	for i := 1; i <= rombongan; i++ {
		jumlahMenu, jumlahOrang, sisaMakanan := inputData(i)
	...
	fmt.Printf("Total biaya untuk semua rombongan: Rp %d\n", totalBiaya)
}
